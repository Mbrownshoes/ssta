...
datesToPlot
  ...
  main.variable(observer("viewof datesToPlot")).define("viewof datesToPlot", ["Inputs","datesCopy","limits"], function(Inputs,datesCopy,limits){return(
Inputs.button("Submit to load", {
  value: null,
  reduce: () => {
