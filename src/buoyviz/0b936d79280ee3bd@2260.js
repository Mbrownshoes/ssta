...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["buoysHWStatusDaily-2.json",new URL("./files/365df8bfd03f7b934dda1457240238b0cda73262ce2f024441c7073e46e0668ed86f5e63e5199695aee642e310f19a78c62942a1432a37b2a9a8515fc4336e9a",import.meta.url)]]);
...
brushFilterX(d3.extent(dates), {
  defaultExtent: [d3.isoParse(start), d3.isoParse(today)]
})
)});
...
limits[0]
  ...
  main.variable(observer("buoyDailyData")).define("buoyDailyData", ["FileAttachment","limits"], async function(FileAttachment,limits)
{
