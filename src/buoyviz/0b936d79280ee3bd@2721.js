...
datesCopy.filter((d) => d >= limits[0] && d <= limits[1])
  ...
  main.variable(observer("viewof datesToPlot")).define("viewof datesToPlot", ["colorView","mutable thing","Inputs","datesCopy","limits"], function(colorView,$0,Inputs,datesCopy,limits)
{
  colorView;
  if ($0.value === 0) {
    $0.value = 1;
